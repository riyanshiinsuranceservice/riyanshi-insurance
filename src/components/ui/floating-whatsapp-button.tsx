...
type FloatingWhatsAppButtonProps = Omit<
...
/**
 * What: fixed WhatsApp launch control (stitch Contact / Home / Lead patterns).
 * Why: same placement, motion, and brand color across screens.
 * What for: one import instead of repeating fixed + z-index + SVG.
 */
